...
Don't forget to join my [support group](https://t.me/kannadaGroupChat) More on my [Developer](https://t.me/VICKY_IN)

information's on all the latest updates.
...
If you have any questions on how to use me, feel free to ask in my [support group](https://t.me/kannadaGroupChat). More on my [Developer](https://t.me/VICKY_IN).
'''
  await teletips.send_message(message.chat.id, text, disable_web_page_preview=True)
